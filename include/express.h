...
#define E_KKT_XML	0x93	/* Ошибка в XML для ККТ */
#define E_KKT_ILL_ATTR	0x94	/* Неверное значение атрибута в XML для ККТ */
#define E_KKT_NO_ATTR	0x95	/* Отсутствует обязательный атрибут для ККТ */
